     ...
     function CheckQuest() 
        ...
        if World1 then
            ...
            elseif (MyLevel >= 375 and MyLevel <= 399) or SelectMonster == "Fishman Warrior" then
                ...
                if getgenv().StartFarm and (CFrameQuest.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude > 10000 then
           ...
           if (MyLevel >= 1500 and MyLevel <= 1524) or SelectMonster == "Pirate Millionaire" then
            ...
            elseif (MyLevel >= 2525 and MyLevel <= 2550) or SelectMonster == "Isle Champion" then
             ...
             elseif MyLevel >= 2600 and MyLevel <=2624 or SlecectMonster == "Reef Bandit" then
                 Mon = "Reef Bandit"
                 LevelQuest = 1
                 NameQuest = "SubmergedQuest1"
                 NameMon = "Reef Bandit"
                 CFrameQuest = CFrame.new(10780.7392578125, -2088.410400390625, 9260.4111328125)
...
elseif MyLevel >= 2650 and MyLevel <= 2674 or SelectMonster == "Sea Chanter" then
            ...
            NameMon = "Sea Chanter"            
            CFrameQuest = CFrame.new(10780.7392578125, -2088.410400390625, 9260.4111328125)
            CFrameMon = CFrame.new(10640.1504, -2091.2478, 10071.0195, 0.241339028, 0.0167052262, -0.970297098, -0.0685447007, 0.99764806, 0.000127200037, 0.968017101, 0.0664780289, 0.241916478)       
                elseif MyLevel >= 2675 or SelectMonster == "Ocean Prophet"  then
                 Mon = "Ocean Prophet"
                 LevelQuest = 2
                 NameQuest = "SubmergedQuest2"
                 NameMon = "Ocean Prophet"
                 CFrameQuest = CFrame.new(10780.7392578125, -2088.410400390625, 9260.4111328125)
                 CFrameMon = CFrame.new(10867.4258, -1994.68054, 10171.0986, 0.99254024, -0.00026013446, 0.121917397, -8.78128776e-05, 0.999995947, 0.00284857792, -0.12191765, -0.00283803395, 0.992536187)    
            end
        end
    end
  function AutoHaki()
...
spawn(function()
        while wait() do
            if getgenv().StartFarm and FarmMode == "Level Farm" then
                pcall(function()
                                ...
                                if string.find(v.Name,"kissed Warrior") then
                                    if v:FindFirstChild("HumanoidRootPart") and v:FindFirstChild("Humanoid") and v.Humanoid.Health > 0 then
                                        if string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, NameMon) then
                                            ...
                                            until not getgenv().StartFarm or FarmMode == "Level Farm" or v.Humanoid.Health <= 0 or not v.Parent or game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == false
                                        else
                                            StartBring = false
                                            game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("AbandonQuest")
                                        end
...
llocal CakePos = CFrame.new(-2130.80712890625, 69.95634460449219, -12327.83984375)
    ...
    while task.wait() do
        ...
        if getgenv().StartFarm and FarmMode == "Farm Katakuri" and World3 then
                        ...
                        for i, v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                            ...
                            if v.Name == "Cookie Crafter" or v.Name == "Cake Guard" or v.Name == "Baking Staff" or v.Name == "Head Baker" then
                                ...
                                if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                    ...
                                    until not getgenv().StartFarm or FarmMode == "Farm Katakuri" or not v.Parent or v.Humanoid.Health <= 0 or game:GetService("Workspace").Map.CakeLoaf.BigMirror.Other.Transparency == 0 or game:GetService("ReplicatedStorage"):FindFirstChild("Cake Prince [Lv. 2300] [Raid Boss]") or game:GetService("Workspace").Enemies:FindFirstChild("Cake Prince [Lv. 2300] [Raid Boss]")
        ...
        while wait() do 
            ...
            pcall(function()
                    ...
                    if game:GetService("Workspace").Enemies:FindFirstChild("Reborn Skeleton") or game:GetService("Workspace").Enemies:FindFirstChild("Living Zombie") or game:GetService("Workspace").Enemies:FindFirstChild("Demonic Soul") or game:GetService("Workspace").Enemies:FindFirstChild("Posessed Mummy") then
                        ...
                        for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                            ...
                            if v.Name == "Reborn Skeleton" or v.Name == "Living Zombie" or v.Name == "Demonic Soul" or v.Name == "Posessed Mummy" then
                                ...
                                if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                    ...
                                    until not getgenv().StartFarm or ModeFarm == "Farm Bone" or not v.Parent or v.Humanoid.Health <= 0
    					...
    					TP("Tweem", CFrame.new(-9506.234375, 172.130615234375, 6117.0771484375))
