...
local Window = Fluent:CreateWindow({Title = "Script BF",SubTitle = "by Skidder Hideout ",TabWidth = 155,Size = UDim2.fromOffset(555, 320),Acrylic = false,Theme = "AMETHYST",MinimizeKey = Enum.KeyCode.End})
local Tabs = {
  Status = Window:AddTab({Title = "Server Status", Icon = ""}),
  Main = Window:AddTab({Title = "Farm", Icon = ""}),
  Settings = Window:AddTab({Title = "Setting and Stats", Icon = ""}),
  Melee = Window:AddTab({Title = "Fighting Style", Icon = ""}),
  Quests = Window:AddTab({Title = "Stack Farm", Icon = ""}),
  SeaEvent = Window:AddTab({Title = "Sea Events", Icon = ""}),
  Mirage = Window:AddTab({Title = "Mirage + RaceV4", Icon = ""}),
  Drago = Window:AddTab({Title = "Draco Race", Icon = ""}),
  Prehistoric = Window:AddTab({Title = "Volcano", Icon = ""}),
...
ImageButton.Image = "rbxassetid://112663179483753"
...
if IsPc then
  if not string.find(executor, "Wave") or not string.find(executor, "AWP") then
    Fluent:Notify({Title = "warning",Content = "not support your’s client someone function donkt work",SubContent = "",Duration = 15})
  else
    Fluent:Notify({Title = "warning",Content = "not support your’s client someone function donkt work",SubContent = "",Duration = 15})
  end
else
  Fluent:Notify({Title = "Welcome to our script ",Content = "Thanks for use",SubContent = "Script made by skidder hideout",Duration = 15})
end
...
FullMOOn = Tabs.Status:AddParagraph({Title = " Full Moon Status ",Content = ""})
spawn(function()
  while wait(.2) do
    pcall(function()
...
Ismirage = Tabs.Status:AddParagraph({Title = " Mirage Island Status ",Content = ""})
spawn(function()
  while wait(.2) do
...
local Check_Volcano = Tabs.Status:AddParagraph({Title = " Prehistoric Island Status ",Content = ""})
spawn(function()
  while wait(.2) do
...
local FloD = Tabs.Status:AddParagraph({Title = " Flozen Dimension Status ",Content = ""})
spawn(function()
  pcall(function()
    while wait(.2) do
...
Tabs.Main:AddButton({Title = "Discord sever", Description = "",Callback = function()
setclipboard("https://discord.gg/ufVrvMK35S")
end})
...
local Q = Tabs.Main:AddToggle("Q", {Title = "Accept Quests", Description = "Bone and Cake prince", Default = false})
Q:OnChanged(function(Value)
...
local duma = Tabs.Main:AddToggle("duma", {
        ...
        if _G.AutoFarmRed then
            pcall(function()
                ...
                for _, v in pairs(enemies:GetChildren()) do
                    if v.Name == "Red Commander" and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                        foundBoss = true
                        repeat
                            task.wait()
                ...
                if not foundBoss then
                    ...
                    if djtme then
                       ...
                       Fluent:Notify({
                       Title = "Notification",
                       Content = "Not Found Red Commander",
                       Duration = 5,
})
                    end
                end
...
Tabs.Main:AddSection("Bone Farm")
...
local v124a = Tabs.Settings:AddDropdown("v124a", {
    Title = "Select Weapon",
    Values = {"Melee", "Sword", "Fruits"},
    Multi = false,
})
v124a:SetValue("Melee")
v124a:OnChanged(function(Value)
...
local Initialize = Tabs.Settings:AddToggle("Initialize", {Title = "Fast Attack", Description = "[ Not Supported Gas M1 ]", Default = true})
...
local BusuAura = Tabs.Settings:AddToggle("BusuAura", {Title = "Auto Turn on haki", Description = "", Default = true})
...
local RandomAround = Tabs.Settings:AddToggle("RandomAround", {Title = "Spin Position", Description = "", Default = false})
RandomAround:OnChanged(function(Value)
  RandomCFrame = Value
end)
local Byp = Tabs.Settings:AddToggle("Byp", {Title = "Turn on Bypass Teleport(patched)", Description = "", Default = false})
Byp:OnChanged(function(Value)
  _G.Bypass = Value
end)
local SafeModes = Tabs.Settings:AddToggle("SafeModes", {Title = "Safe Farm", Description = "turn on for safe ur health if low", Default = false})
...
local DisblesVFX = Tabs.Settings:AddToggle("DisblesVFX", {Title = "Remove Hit ", Description = "", Default = false})
...
local DisblesVFX = Tabs.Settings:AddToggle("DisblesVFX", {Title = "Remove Death & Respawn", Description = "", Default = false})
DisblesVFX:OnChanged(function(Value)
  RDeath = Value
end)
spawn(function()
...
local Process = Tabs.Quests:AddParagraph({Title = "Elites Status ",Content = ""})
spawn(function()
  while wait(Sec) do
    pcall(function()    
...
local FactoryRaids = Tabs.Quests:AddToggle("FactoryRaids", {Title = "Auto Factory Raid", Description = "", Default = false})
...
local Berry = Tabs.Quests:AddToggle("Berry", {Title = "Auto Collect Berry", Description = "", Default = false})
...
Tabs.Quests:AddSection("Upgrade Races V3")
local Q = Tabs.Quests:AddToggle("Q", {Title = "Auto Upgrade Mink V3", Description = "", Default = false})
Q:OnChanged(function(Value)
  _G.Auto_Mink = Value
end)
spawn(function()
...
local Q = Tabs.Quests:AddToggle("Q", {Title = "Auto Upgrade Human V3", Description = "", Default = false})
Q:OnChanged(function(Value)
  _G.Auto_Human = Value
end)
spawn(function()
...
local Q = Tabs.Quests:AddToggle("Q", {Title = "Auto Upgrade Skypiea V3", Description = "", Default = false})
Q:OnChanged(function(Value)
...
local Q = Tabs.Quests:AddToggle("Q", {Title = "Auto Upgrade FishMan V3", Description = "", Default = false})
Q:OnChanged(function(Value)
  _G.Auto_Fish = Value
end)
spawn(function()
...
Tabs.Quests:AddSection("Rip Indra/ Dough King")
local Q = Tabs.Quests:AddToggle("Q", {Title = "Auto Valkyrie", Description = "", Default = false})
Q:OnChanged(function(Value)
...
local Q = Tabs.Quests:AddToggle("Q", {Title = "Auto Farm Mirror", Description = "", Default = false})
Q:OnChanged(function(Value)
  _G.AutoMiror = Value
end)
spawn(function()
...
Tabs.Quests:AddSection("Quest Sea")
local TravelDress = Tabs.Quests:AddToggle("TravelDress", {Title = "Auto Quest World 2", Description = "", Default = false})
...
local Zou = Tabs.Quests:AddToggle("Zou", {Title = "Auto Quest World 3", Description = "", Default = false})
...
Tabs.Quests:AddSection("Haki Rainbow")
local Q = Tabs.Quests:AddToggle("Q", {Title = "Auto Rainbow Colors", Description = "", Default = false})
Q:OnChanged(function(Value)
...
local Q = Tabs.Quests:AddToggle("Q", {Title = "Accept Rainbow Quest Faster", Description = "", Default = false})
Q:OnChanged(function(Value)
  _G.GetQFast = Value
end)

Tabs.Quests:AddSection("Instinct / Observation")
local Q = Tabs.Quests:AddToggle("Q", {Title = "Auto Farm Observation", Description = "", Default = false})
Q:OnChanged(function(Value)
  _G.obsFarm = Value
end)
spawn(function()
...
local Q = Tabs.Quests:AddToggle("Q", {Title = "Auto Observation V2", Description = "", Default = false})
Q:OnChanged(function(Value)
...
Tabs.Quests:AddSection("Law raid")
...
local Bartilo = Tabs.Quests:AddToggle("Bartilo", {Title = "Auto Done Bartilo Quest", Description = "", Default = false})
...
local CitizenQ = Tabs.Quests:AddToggle("CitizenQ", {Title = "Auto Done Citizen Quest", Description = "", Default = false})
...
local Q = Tabs.Quests:AddToggle("Q", {Title = "Auto Training Dummy", Description = "", Default = false})
Q:OnChanged(function(Value)
  _G.DummyMan = Value
end)
spawn(function()
...
Tabs.Quests:AddSection("Unlocked Dungeon")
local Q = Tabs.Quests:AddToggle("Q", {Title = "Auto Unlock Dough dungeon", Description = "", Default = false})
Q:OnChanged(function(Value)
  _G.Doughv2 = Value
end)
spawn(function()
...
local Q = Tabs.Quests:AddToggle("Q", {Title = "Auto Unlock Phoenix dungeon", Description = "", Default = false})
Q:OnChanged(function(Value)
...
Tabs.Travel:AddSection("Teleport - Worlds")
Tabs.Travel:AddButton({Title = "Teleport World 1", Description = "",
Callback = function()
  replicated.Remotes.CommF_:InvokeServer("TravelMain")
end})
Tabs.Travel:AddButton({Title = "Teleport World 2", Description = "",
Callback = function()
  replicated.Remotes.CommF_:InvokeServer("TravelDressrosa")
end})
Tabs.Travel:AddButton({Title = "Teleport World 3", Description = "",
Callback = function()
  replicated.Remotes.CommF_:InvokeServer("TravelZou")
end})
...
GoIsland = Tabs.Travel:AddToggle("GoIsland", {Title = "Tween", Description = "Automatic teleport to pos island", Default = false})
...
Tabs.Travel:AddButton({Title = "Teleport", Description = "",Callback = function()
...
Tabs.Fruit:AddButton({Title = "Buy Normal Stock", Description = "",Callback = function()
  replicated.Remotes.CommF_:InvokeServer("PurchaseRawFruit",_G.SelectFruit)
end})
Tabs.Fruit:AddButton({Title = "Open normal Stock", Description = "",Callback = function()
...
Tabs.Fruit:AddButton({Title = "Open Mirage Stock", Description = "",Callback = function()
  local function playDlg(id)
    local rs = game:GetService("ReplicatedStorage")
    local dlgCtrl = require(rs.DialogueController)
    local dlgList = require(rs.DialoguesList)
