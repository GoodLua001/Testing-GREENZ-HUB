...
corner.Parent = LogoHeader
	...
	pcall(setclipboard, "https://discord.gg/zeroxhub/")
...
dropdown = SF:Dropdown({
    Title = "Select Pos",
    List = table.create(#getgenv().PosSave, function(i) return tostring(getgenv().PosSave[i]) end),
    Value = getgenv().Pos and tostring(getgenv().Pos) or nil,
    Multi = false,
