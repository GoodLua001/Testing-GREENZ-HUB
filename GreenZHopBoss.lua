...
local Tabs = {
	Informaiton=Window:AddTab({ Title="Information" }),
...
ImageButton.Image="http://www.roblox.com/asset/?id=136682885627552"
...
tableBoss={"rip_indra True Form","Dough King","Darkbeard"}
    end
